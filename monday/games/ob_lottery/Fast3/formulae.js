class TotalBets {
      ...
      // returns the combination of a numb and the sample
    getCombination = (n , r) => {
    if(!(r >= 0 && n >=r)) return 0;
...
function factorial(num){
    ...
    // return the factorial for 0
    if(num == 0) return 1;
    
    //NB: this will generate an error
    if(num < 0) return 0;

    //set the result of the factorial to the 
    // {@num} parameter
    let result = num

    // loop through the and calculate the factorial
